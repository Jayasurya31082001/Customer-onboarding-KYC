...
public class AccountServiceClient {
    ...
    public AccountServiceClient(@Qualifier("accountRestClient") RestClient restClient) {
    ...
    public PagedSyncResponse<AccountSyncRecord> fetchPage(
    ...
    @Recover
    public PagedSyncResponse<AccountSyncRecord> recover(
