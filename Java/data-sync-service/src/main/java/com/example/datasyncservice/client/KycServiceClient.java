...
public class KycServiceClient {
    ...
    public KycServiceClient(@Qualifier("kycRestClient") RestClient restClient) {
    ...
    public PagedSyncResponse<KycSyncRecord> fetchPage(
    ...
    @Recover
    public PagedSyncResponse<KycSyncRecord> recover(
